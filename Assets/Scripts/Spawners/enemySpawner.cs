...
public class enemySpawner : MonoBehaviour
{
    ...
    {
        imagegeneration.makeURLImages("Medieval Dragon spewing fire from its mouth", () =>           //need to modify so that it changes it from Goblin to monster description AiImageGeneration.
        {
